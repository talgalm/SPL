...
public abstract class MicroService implements Runnable {
    ...
    private Hashtable<Class,Callback> Callbacks = new Hashtable<>();
    ...
    public MicroService(String name) {
        this.name = name;
        this.id = messageBus.getCounterID().get();
        messageBus.setCounterID();
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            ...
            } catch (InterruptedException | IllegalStateException | IOException ignored) {}
        }
    ...
    {
        messageBus.setFuturesOfEvent(e,f);
    }

    public int getId() {
        return id;
    }
    public Future<Model> getFuture(Event event)
    {
        Future<Model> f =  messageBus.getFutures().get(event);
        return f;
    }
